                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="<?= base_url('tags/attendance_tags'); ?>" class="btn btn-warning  mr-2 text-light"><i class="fas fa-undo mr-1"></i>Back</a>
                        </div>
                    </div>
                            ...
                            <form action="" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="hidden" id="site_id" name="site_id" value="<?= $tags['site_id'] ?>" class="form-control">
                                        <input type="text" id="site" name="site" class="form-control" value="<?= $tags['site'] ?>" readonly>
                                ...
                                <div class="form-group">
                                    <label for="nfcid" class=" form-control-label">Tag ID</label>
                                    <div class="input-group">
                                        <input type="text" id="nfcid" name="nfcid" class="form-control" value="<?= $tags['nfcid'] ?>">
                                        <span class="input-group-append">
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" name="status" type="checkbox" id="customCheckbox1" value="1" <?= $tags['gms_status'] == 1 ? 'checked' : '' ?>>
