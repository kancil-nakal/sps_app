                    ...
                    <div class="card-body row">
                        ...
                        <div class="col-md-4 ">
                            <form action="" method="post">
                                <input type="hidden" name="nfcid" id="nfcid" value="<?= $tags['nfcid'] ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="tagid" name="tagid" class="form-control" value="<?= $tags['tagid'] ?>" readonly>
                                        <span class="input-group-append">
                                ...
                                <div class=" form-group">
                                    ...
                                    <input type="label" id="label" name="label" class="form-control" value="<?= $tags['label'] ?>" readonly>
                                    <?= form_error('label', '<small class="text-danger">', '</small>'); ?>
                                </div>
                                <div class=" form-group">
                                    <label for="location" class=" form-control-label">Location</label>
                                    <textarea type="text" id="location" name="location" class="form-control" required><?= $tags['location'] ?> </textarea>
                                    <?= form_error('location', '<small class="text-danger">', '</small>'); ?>
                                </div>
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" name="status" type="checkbox" id="customCheckbox1" value="1" <?= $tags['is_active'] == 1 ? 'checked' : '' ?>>
