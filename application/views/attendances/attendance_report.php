    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body">
                    <div class="row">
                        <form action="<?= base_url('report/attendance/export'); ?>" method="post">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <button class="btn btn-lg btn-primary" type="submit" name="submit"><i class="fa fa-file-excel-o"></i> Export Excel</button>
                                </div>
                            </div>
                            <div class=" col-md-12">
                                <div class="form-group">
